...
Usage - predict using YOLOv8-pose:
    $ python pose_widerface.py --model yolov8n-pose_widerface.pt --source ../datasets/widerface/images/val/ --folder_pict ../datasets/widerface/wider_face_split/wider_face_val_bbx_gt.txt --save_txt true --imgsz 640 --conf 0.001 --iou 0.6 --max_det 1000 --batch 1 --device 0
...
class WiderFacePredictor(PosePredictor):
    ...
    def postprocess(self, preds, img, orig_imgs):
        ...
        for pred, orig_img, img_path in zip(preds, orig_imgs, self.batch[0]):
            ...
            results.append(
                ...
                WiderFaceResults(orig_img, path=img_path, names=self.model.names, boxes=pred[:, :6],
                                 keypoints=pred_kpts)
            )
        return results
