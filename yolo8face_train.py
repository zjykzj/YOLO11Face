...
Usage - training using YOLOv5:
    $ python3 yolo8face_train.py --model yolov5nu.pt --data ./yolo8face/cfg/datasets/widerface.yaml --device 0
...
Usage - training using YOLOv8:
    $ python3 yolo8face_train.py --model yolov8n.pt --data ./yolo8face/cfg/datasets/widerface.yaml --device 0
